      ...
      <main className="pt-24 pb-20">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            >
              <div className="relative overflow-hidden rounded-2xl border-2 border-[#25D366] bg-gradient-to-r from-[#075E54] to-[#128C7E] p-6 text-center shadow-[0_0_30px_rgba(37,211,102,0.2)]">
                <div className="relative z-10 flex flex-col items-center gap-3">
                  ...
                  >
                    Chat on WhatsApp: +8801842900265
                  </a>
                </div>
              </div>
            </motion.div>
