...
import { ArrowLeft, Calculator, Dna, FlaskConical, Atom, Beaker, Languages, BookOpen } from "lucide-react";
...
const subjects = [
  ...
  {
    name: "Science (Double Awards)",
    slug: "science-double-awards",
    icon: Beaker,
  },
  {
    name: "English Language B",
    slug: "english-language-b",
    icon: Languages,
  },
  {
    name: "Accounting",
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-2xl mx-auto space-y-3">
            {subjects.map((subject, index) => (
              <Link key={subject.name} to={`/igcse-modular-past-papers/${subject.slug}`}>
                <motion.div
